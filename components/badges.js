...
function createMarginBadge(side, status) {
...
function createAlertsBadge(alertsCount) {
...
if (typeof window !== 'undefined') {
    window.createMarginBadge = createMarginBadge;
    window.createStatusBadge = createStatusBadge;
    window.createWeekBadge = createWeekBadge;
    window.createAlertsBadge = createAlertsBadge;
