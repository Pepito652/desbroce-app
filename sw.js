const CACHE_NAME = 'road-clearing-cache-v0.1.11-2020';
const VERSION = '0.1.11';
const UPDATE_NOTES = 'Hotfix #2020: Corregido desenfoque (blur) al deslizar el menu y restaurado ancho original del panel.';
